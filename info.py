...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5296610774 1652683874').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', "-1001852649500")
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), True)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Movies1:Movies2@cluster0.7w61tbf.mongodb.net/?retryWrites=true&w=majority")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/nonstopcinema02')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movies4uu1')
